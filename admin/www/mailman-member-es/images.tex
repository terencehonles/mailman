...
\author{Terri Oda}\authoraddress{terri(en)zone12.com}
...
\hyphenation{listinfo listinfo}\hyphenation{NOMBRELISTA NOMBRELISTA}\hyphenation{private private}\hyphenation{digest digest}\hyphenation{password password}%
\renewcommand{\note}{\bf Nota: \rm}%
