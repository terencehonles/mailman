    ...
    def GetConfigInfo(self):
        ...
        return [
            ...
            ('nntp_host', mm_cfg.String, WIDTH, 0,
             _('The Internet address of the machine your News server '
               'is running on.'),
            ...
            ('gateway_to_news',  mm_cfg.Toggle, (_('No'), _('Yes')), 0,
             _('Should new posts to the mailing list be sent to the newsgroup?')),

            ('gateway_to_mail',  mm_cfg.Toggle, (_('No'), _('Yes')), 0,
             _('Should new posts to the newsgroup be sent to the mailing list?')),
